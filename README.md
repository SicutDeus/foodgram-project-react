[![foodgram_workflow](https://github.com/SictuDeus/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)](https://github.com/SicutDeus/foodgram-project-react/actions/workflows/foodgram_workflow.yml)
...
```bash
HTTPS: git clone https://github.com/SicutDeus/foodgram-project-react.git
SSH: git clone git@github.com:SicutDeus/foodgram-project-react.git
```
...
```bash
docker build -t sojourun/foodgram_backend .
```

Из папки "./frontend/" выполнить команду:
```bash
docker build -t sojourun/foodgram_frontend .
```
...
API фреймворк: DRF (контейнер backend)  
